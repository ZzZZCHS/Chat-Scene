...
outputs = json.load(open("/mnt/petrelfs/huanghaifeng/share/Chat-3D-v2/outputs/20240411_012742_dp0.1_lr5e-6_sta2_ep3_scannet_caption#scanrefer_caption#scannet_region_caption#nr3d_caption#scanrefer#obj_align#scanqa#sqa3d__scanqa#scanrefer#scan2cap#sqa3d__lora+sqa3d/preds_epoch1_step4596_scanqa.json", "r"))
...
for i, output in enumerate(outputs):
    ...
    # pred = pred
    # ref_captions = [caption for caption in ref_captions]
    output["pred"] = pred
